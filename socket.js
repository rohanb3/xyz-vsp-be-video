...
function socket(server) {
  ...
  function notifyCustomersAboutOperatorsLength() {
    ...
    return getOperatorsLengthData()
      .then(data => customers.emit(OPERATORS_LENGTH, data));
  }
